...
public class JuegoPrincipal extends javax.swing.JFrame {
    ...
    private Fondito f;
    private LogicaJuego logistica = new LogicaJuego();
    ...
    public JuegoPrincipal() {
        ...
        f = new Fondito(getWidth(), getHeight());
        add(f, BorderLayout.CENTER);
        setCards();
    }       
    
    private void setCards() {
        int[] numbers = logistica.getCardNumbers();
        
        btnC1.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[0]+".png")));
        btnC2.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[1]+".png")));
        btnC3.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[2]+".png")));
        btnC4.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[3]+".png")));
        btnC5.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[4]+".png")));
        btnC6.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[5]+".png")));
        btnC7.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[6]+".png")));
        btnC8.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[7]+".png")));
        btnC9.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[8]+".png")));
        btnC10.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[9]+".png")));
        btnC11.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[10]+".png")));
        btnC12.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[11]+".png")));
        btnC13.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[12]+".png")));
        btnC14.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[13]+".png")));
        btnC15.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[14]+".png")));
        btnC16.setDisabledIcon(new ImageIcon(getClass().getResource("../cartitas/c"+numbers[15]+".png")));
    }    
    ...
    private void pregwin() {
        if(!btnC1.isEnabled() && !btnC2.isEnabled() && !btnC3.isEnabled() && !btnC4.isEnabled() && !btnC5.isEnabled() && !btnC6.isEnabled() && 
            ...
            JOptionPane.showMessageDialog(this, "juego terminado, Su puntaje es: "+score, " ", JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        btnC1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        btnC13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cartitas/C0.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(599, 538));
